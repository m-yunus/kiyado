...
const CartItem = ({
  item: { id, title, text, image, color, shadow, price, cartQuantity },
}) => {
  ...
  const onIncreaseQty=()=>{
    dispatch(setIncreaseQty({id, title, text, image, color, shadow, price, cartQuantity}))
  }
  const onDecreaseQty=()=>{
    dispatch(setDecreaseQty({id, title, text, image, color, shadow, price, cartQuantity}))
  }
  return (
    <>
        ...
        <div className="flex items-center gap-5">
          ...
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              <button type="button"  className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex items-center justify-center active:scale-90" onClick={onDecreaseQty}>
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button type="button" className="bg-theme-cart rounded p-1 lg:p-0.5 grid items-center justify-items-center cursor-pointer" onClick={onRemoveItems} >
